...
public class JavaModelCodeGeneratorTest {
    ...
    void classNameTest1() {
        ...
        assertEquals("com.example.admin_users.post.RequestBody", name);
    }
    ...
    void createJavaClasses2() {
        ...
        String javaClass = """
                package io.someco.restapi.admin_users.post;
        ...
        assertEquals(JsonObject.EMPTY.put("io.someco.restapi.admin_users.post.RequestBody", javaClass), javaClasses);
    }
    ...
    void createJavaClasses3() {
        ...
        String javaClass1 = """
                package com.example.admin_users.post;
                
                public class RequestBody {
                    public final com.example.admin_users.post.RequestBody_prop1 prop1;
                
                    public final com.example.admin_users.post.RequestBody_prop1 getProp1() {
                        return prop1;
                    }
                }""";
